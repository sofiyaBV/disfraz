...
export class Migration1743190070234 implements MigrationInterface {
    name = 'Migration1743190070234'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
          `CREATE TABLE "order" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "customerName" character varying(255) NOT NULL, "customerEmail" character varying(255) NOT NULL, "customerPhone" character varying(20) NOT NULL, "deliveryAddress" text NOT NULL, "deliveryMethod" "public"."order_deliverymethod_enum" NOT NULL, "notes" text, "status" character varying(50) NOT NULL DEFAULT 'Pending', "cartId" integer, "userId" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
          `ALTER TABLE "order" ADD CONSTRAINT "FK_fe3963d525b2ee03ba471953a7c" FOREIGN KEY ("cartId") REFERENCES "cart"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
